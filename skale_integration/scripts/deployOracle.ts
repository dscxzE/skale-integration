...
const assetSources = [
  {
    ...
    privateKey:
      "0x2b5e714ff903b8737c794f5ff0eca455740f91c108d01f17ce49be21f0495a64",
  },
  {
    symbol: "ETH",
    ...
    privateKey:
      "0x84300c9c31b59e51966f8160511a83250b6c9afe58e0df72d357d44ec61785b9",
  },
  {
    symbol: "XRP",
    ...
    privateKey:
      "0x625e9eee51bd851f4f819b38fd0819a6b0ba2adb9195c69b04dd918ff926e0cf",
  },
  {
    symbol: "TRON",
    ...
    privateKey:
      "0x28d28bb2478c8281ab5b255c2be97410fad8a481813613482bb18376367c0272",
  },
  {
    symbol: "BNB",
    ...
    privateKey:
      "0x687f60f76064cf379c1e9c5b650587e863c3fe943d2e3eb37eaa4f0b6d2afa40",
  },
  {
    symbol: "USDT",
    ...
    privateKey:
      "0x702973292cd1d65148d7ca37e76f7e738841d361d72dc3290ffdf41bdf4d84a7",
  },
];
...
const transferOwner = async () => {
  for (let i = 0; i < assetSources.length; i++) {
    ...
    const vistiaPriceFeed = await ethers.getContractAt(
      "vistiaPriceFeed",
      assetSource.source
    );

    const transferOwnershipTx = await vistiaPriceFeed
      .connect(account2)
